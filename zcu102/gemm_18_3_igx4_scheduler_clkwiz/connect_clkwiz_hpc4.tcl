...
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm1_hpc1_if/s_axi_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm1_hpc1_if/acc_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm2_hpc2_if/s_axi_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm2_hpc2_if/acc_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm3_hpc3_if/s_axi_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm3_hpc3_if/acc_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm4_hpc4_if/s_axi_aclk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins gemm4_hpc4_if/acc_aclk]
