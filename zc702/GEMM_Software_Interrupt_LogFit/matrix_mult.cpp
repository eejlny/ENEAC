...
{ 
	...
	//	printf("call parallel for\n");
		hs.heterogeneous_parallel_for(0, rows, &body);	//For the original LogFitScheduler.h
		////hs.heterogeneous_parallel_for(0, rows, &body, 256);	//Logfit block size exploration is limited to 256
	}
