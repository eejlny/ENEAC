...
*/
 ...
 //// int k,ret_value,enable;
  ...
  sobel_filter(array_temp_fpga, array_power_fpga, array_out_fpga, Cap_1, Rx_1, Ry_1, Rz_1, line_count1);
  ...
  sobel_filter(array_temp_fpga,array_power_fpga, array_out_fpga,Cap_1, Rx_1, Ry_1, Rz_1,line_count2);
  ////ret_value = ioctl(file_desc,IOCTL_WAIT_INTERRUPT,0); //this should put this process to sleep until interrupt takes place
  #pragma SDS wait(1)
  #pragma SDS wait(2)
