...
int compute_tran_temp(float *array_temp,float* array_power, float *array_result, int col, int row, int total_iterations, int num_iterations) 
{ 
...
////    printf("Switc#include "../Schedulers/LogFitScheduler.h"  //MODIFIED LINES
HSchedulerLogFit hs;		//MODIFIED LINESh on leds\n");
